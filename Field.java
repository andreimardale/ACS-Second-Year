...
public class Field {
	...
	public Field(int[][] small, int [][] big ) {
		mBoard = big;
		mMacroboard = small;
	}
	...
	public int getValueOfMacro (int x, int y){
		return this.mMacroboard[x][y];
	}
	
	public void setMacroboard (int r, int c, int value){
		this.mMacroboard[r][c] = value;
	}
